...
public class AndroidHarness extends AppCompatActivity implements TouchListener, DialogInterface.OnClickListener, SystemListener {
     ...
     */
    protected int splashPicID = R.drawable.splash;
...
//tharg                splashImageView.setBackgroundDrawable(drawable);
                splashImageView.setBackground(drawable);
            } else {
//tharg                splashImageView.setImageResource(splashPicID);
                splashImageView.setBackground(drawable);
            }
...
//tharg            if (splashImageView.getParent() != null) {
